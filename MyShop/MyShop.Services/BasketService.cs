    ...
    public class BasketService : IBasketService
    {
        ...
        private Basket GetBasket(HttpContextBase httpContext, bool createIfNull)
        {
            ...
            if (cookie != null)
            {
                ...
                {
                    basket = this.basketContext.Find(basketId);
                }
                else
                {
                    if (createIfNull)
        ...
        public List<BasketItemViewModel> GetBasketItems(HttpContextBase httpContext)
        {
            ...
            if (basket != null)
            {
                var result = (from b in basket.BasketItems
                              join p in this.productContext.Collection() on b.ProductId equals p.Id
        ...
        public BasketSummaryViewModel GetBasketSummary(HttpContextBase httpContext)
        {
            ...
            if (basket != null)
            {
                ...
                decimal? basketTotal = (from item in basket.BasketItems join p in this.productContext.Collection() on item.ProductId equals p.Id
